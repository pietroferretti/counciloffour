...
public class RegionBonusesChangedMsg implements Message {
	...
	public RegionBonusesChangedMsg(int newBonusGold, int newBonusSilver,
		...
		this.newBonusBlue = newBonusBlue;
	}

	public int getNewBonusGold() {
		return newBonusGold;
	}

	public int getNewBonusSilver() {
		return newBonusSilver;
	}

	public int getNewBonusBronze() {
		return newBonusBronze;
	}
