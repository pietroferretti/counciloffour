...
public class Player extends Observable implements Serializable {
     ...
     * @param coins starting coins
     * @param assistants number of assistant
     * @param deck politic deck from gameboard to draw politicCards
     * @param numberOfCards number of politic cards to drawn
