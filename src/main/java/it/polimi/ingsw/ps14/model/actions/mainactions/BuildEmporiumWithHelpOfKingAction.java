...
public class BuildEmporiumWithHelpOfKingAction extends MainAction {
    ...
    public boolean isValid(Model model) {
        ...
        LOGGER.info("player has coins enough to move king");
        return true;
    }
     ...
     *
     * @param start where king is now
     * @param stop where king wants to go
